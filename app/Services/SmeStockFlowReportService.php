...
class SmeStockFlowReportService
{
    ...
    public static function generate(array $payload): string
    {
        ...
        if (in_array('purchase_orders', $sections) && !empty($payload['po_by_item'])) {
            $bodyHtml .= self::renderPoByItem($payload['po_by_item']);
        }
        if (in_array('po_by_site', $sections) && !empty($payload['po_by_site'])) {
            $bodyHtml .= self::renderPoBySite($payload['po_by_site']);
        }
        if (in_array('po_by_number', $sections) && !empty($payload['po_by_number'])) {
            $bodyHtml .= self::renderPoByNumber($payload['po_by_number']);
        }
        ...
        <div class="section">
            ...
            <div class="kpi-grid">
                ...
                <div class="kpi kpi-out">
                    ...
                    <div class="kpi-sub">Approved Purchase Orders</div>
                </div>
    ...
    private static function renderPoByItem(array $data): string
    {
        $rows = '';
        $alt  = false;
        ...
        foreach ($data as $row) {
            ...
            foreach ($row['issuance_types'] ?? [] as $typeName => $typeData) {
                ...
                $typeHtml .= "<div class='type-row'><span class='pill'>{$tName}</span> <strong>{$sub} units</strong> {$sizes}</div>";
            }
        ...
        return <<<HTML
        <div class="section">
            <div class="section-title">Purchase Orders by Item</div>
            <table>
                <thead><tr>
                    <th>Item</th>
    ...
    private static function renderPoBySite(array $data): string
    {
        $rows = '';
        $alt  = false;
        ...
        return <<<HTML
        <div class="section">
            <div class="section-title">Purchase Orders by Site</div>
            <table>
                <thead><tr>
                    <th>Site</th>
                    <th>Breakdown by Item</th>
                    <th class="th-right">Total Units</th>
                </tr></thead>
                <tbody>{$rows}</tbody>
            </table>
    ...
    private static function renderPoByNumber(array $data): string
    {
        $rows = '';
        $alt  = false;
        ...
        return <<<HTML
        <div class="section">
            <div class="section-title">Purchase Orders by PO Number</div>
            <table>
                <thead><tr>
                    <th>PO Number</th>
...
<div class="report-page">
    ...
    <table class="dept-row">
        <tr>
            ...
            <td class="report-label">SME Stock Flow Report</td>
        </tr>
    </table>
